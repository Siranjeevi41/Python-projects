...
# Example 3: Find the student with the highest average marks using lambda and max
highest_scorer = max(students, key=lambda student: sum(student["marks"]) / len(student["marks"]))
